...
public:
    ...
    const glm::vec3& getLightDirection() const { return _lightDirection; }
...
LightCube::LightCube()
    ...
    , _lightDirection(-0.2f, -1.0f, -0.3f)
    , _lightScale(0.2f)
...
bool OpenGLWindow::run() {
    ...
    auto drawWoodenBox = [&]() {
        ...
        _lightingShader.setVec3("light.direction", _lightCube.getLightDirection());
